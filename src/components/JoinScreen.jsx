...
export default function JoinScreen({ onJoin }) {
  ...
  return (
    <div className="flex items-center justify-center h-[100dvh] bg-gray-100 dark:bg-gray-900 relative">
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 1, ease: "easeOut" }}
        className="flex flex-col m-6 items-center justify-center p-10 py-20 md:p-20 rounded-2xl shadow-lg bg-white dark:bg-gray-800 gap-6 w-md"
      >
